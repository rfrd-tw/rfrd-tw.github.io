  // Build Json for prop
  const prop = '{ "prop" : [' +
  '{"num": "07","full_case": "Do you agree that the electricity output of thermal power plants should be lowered by \\"at least 1 percent per year on average\\"?" , "Reasoning": "1. Many recent studies have shown that PM 2.5 is closely related to adverse health outcomes, especially for the elderly and children. <br><br> 2. Air pollution in Taiwan has been exacerbated by President Tsai\'s \\"2025 Nuclear-free Homeland\\" policy. If the plan proceeds, 80% of the electricity output in Taiwan will be generated by thermal power plants by 2025, which will put the health of all of the Taiwanese people under threat. <br><br> 3. President Tsai is sacrificing the health of the residents in central and southern Taiwan to her nuclear-free energy policy since most of the thermal power plants are located in those areas.", 
    "src_map": "https://plotdb.io/v/chart/19356?q=7&lang=en", "ratio":"40.27%", "result":"Approved"},' +
  '{"num": "08","full_case": "Do you agree that Taiwan should establish an energy policy that undertakes not to construct any new coal-fired power plants or generators or expand existing facilities (including the expansion of the Shen-ao Power Plant)?","Reasoning": "The current coal-fired electricity output in Taiwan has already met the government\'s target in the \\"2025 Nuclear-free Homeland\\" plan. The Shen\'ao Power Plant expansion project is therefore unnecessary and should be abandoned.", 
    "src_map": "https://plotdb.io/v/chart/19356?q=8&lang=en", "ratio":"38.46%", "result": "Approved"},' +
